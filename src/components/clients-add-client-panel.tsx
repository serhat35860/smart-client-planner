    ...
    <>
      <div className="rounded-2xl bg-white p-3 shadow-sm">
        <button
          ...
          className="w-full rounded-xl px-4 py-3 text-left text-sm font-semibold text-[var(--ui-accent-contrast)] transition hover:opacity-95 active:opacity-90"
        ...
        >
          ...
          >
            <div className="mb-4 flex items-start justify-between gap-3">
              <h2 id="clients-new-client-title" className="text-lg font-semibold text-slate-900">
                {t("add_client")}
              </h2>
              <button
                type="button"
